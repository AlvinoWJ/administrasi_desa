...
public class RoundedPasswordField  extends JPasswordField  {
    ...
    // Konstruktor default (wajib agar bisa muncul di Palette NetBeans)
    public RoundedPasswordField() {
        this(20); // Default 20 kolom
    }

    // Konstruktor dengan jumlah kolom
    public RoundedPasswordField(int columns) {
        super(columns);
        setOpaque(false);
        setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10)); // Padding teks
    }
